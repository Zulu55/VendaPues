...
namespace Orders.Backend.Migrations
{
    ...
    [Migration("20240601000049_AddEntitiesBanksAndOrderPayments")]
    partial class AddEntitiesBanksAndOrderPayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orders.Shared.Entities.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Orders.Shared.Entities.OrderPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Orders.Shared.Entities.InventoryDetail", b =>
                {
                    b.HasOne("Orders.Shared.Entities.Inventory", "Inventory")
            ...
            modelBuilder.Entity("Orders.Shared.Entities.OrderPayment", b =>
                {
                    b.HasOne("Orders.Shared.Entities.Bank", "Bank")
            ...
            modelBuilder.Entity("Orders.Shared.Entities.Purchase", b =>
                {
                    b.HasOne("Orders.Shared.Entities.Supplier", "Supplier")
                        .WithMany("Purchases")
            ...
            modelBuilder.Entity("Orders.Shared.Entities.PurchaseDetail", b =>
                {
                    ...
                    b.HasOne("Orders.Shared.Entities.Purchase", "Purchase")
                        .WithMany("PurchaseDetails")
